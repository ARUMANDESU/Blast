...
#include "Blast/PlayerController//BlastPlayerController.h"
#include "Blast//HUD/BlastHUD.h"
...
{
	if(Character == nullptr && Character->Controller == nullptr) {return; UE_LOG(LogTemp, Warning,TEXT("HUD"));}
